...
def call_llm(
    ...
    payload = {
        ...
        "response_format": {
            "type": "json_schema",
            "json_schema": {
                "name": "create_cargowise_shipment_from_data_v2",
                "strict": True,
                "description": "Extracts shipment details from a source and formats it as a JSON object that can be converted to a CargoWise UniversalShipment XML.",
                "schema": json_schema,
            },
        },
